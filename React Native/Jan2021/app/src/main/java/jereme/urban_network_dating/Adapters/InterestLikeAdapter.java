...
public class InterestLikeAdapter extends RecyclerView.Adapter<InterestLikeAdapter.MyViewHolder> {
    private List<InterestList> titlelist;
    private Context context;
    int index=0;
    int type;
    public InterestLikeAdapter(Context context, ArrayList<InterestList> selectlooking, int i) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_like_interesting, parent, false);
