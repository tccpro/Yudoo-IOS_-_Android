...
public class BottomsheetBothLikeFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable
        ...
        View v = inflater.inflate(R.layout.bottom_both_like, container, false);
        context = getActivity();
        ...
        et_message = v.findViewById(R.id.et_like_message);
...
//                startActivity(intent);
                selectedMessageName = "Like message";
                selectedMessageDescription = et_message.getText().toString(); //"";
                new BottomsheetBothLikeFragment.SendMessage().execute();
            }
        });
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            Toast.makeText(getActivity(),
                                    "Json parsing error 222: " + e.getMessage(),
