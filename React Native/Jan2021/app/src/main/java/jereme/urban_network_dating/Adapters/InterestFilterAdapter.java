...
public class InterestFilterAdapter extends RecyclerView.Adapter<InterestFilterAdapter.MyViewHolder> {
    ...
    int index=0;
    int type;
    private  OnAddInterestClickListener onAddInterestClickListener;
    public InterestFilterAdapter(Context context, ArrayList<InterestList> interestlist, int type,OnAddInterestClickListener onAddInterestClickListener) {
        this.context=context;
        this.titlelist=interestlist;
        this.type=type;
        this.onAddInterestClickListener=onAddInterestClickListener;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_filter_interest, parent, false);
        ...
        if(position==titlelist.size()-1){
            ...
            holder.add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onAddInterestClickListener.onAddIterestClick("1");
                }
            });
        }
...
//        }
    ...
    public interface OnAddInterestClickListener {
        void onAddIterestClick(String add);
    }
}
